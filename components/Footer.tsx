    ...
    <footer className="border-t border-black/10 dark:border-white/10 mt-16 bg-green-900 text-white">
      <div className="max-w-7xl mx-auto px-6 py-10 grid gap-8 md:grid-cols-3">
        <div>
          ...
          <p className="mt-3 text-sm text-gray-100 font-medium">
            Supporting students with health, career, and life skills resources.
          </p>
        </div>
        <div>
          <h4 className="font-semibold mb-3">Quick Links</h4>
          <ul className="space-y-2 text-sm text-gray-100 font-medium">
            <li>
      ...
      <div className="border-t border-gray-400 dark:border-white/10">
        <div className="max-w-7xl mx-auto px-6 py-4 text-xs flex items-center justify-between text-gray-100 font-bold">
